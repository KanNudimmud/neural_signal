%% Simulating EEG data
% The goal is to simulate time series data
...
% copy/paste the code above but add something inside the sine 
...
for chani=1:EEG.nbchan
    for triali=1:EEG.trials
        ...
        % instantaneous frequency via interpolated random numbers
